...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-27 18:28`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3fa72ab1-53c8-4a14-bcde-49101a01fbf3.git
$ cd 3fa72ab1-53c8-4a14-bcde-49101a01fbf3
```
